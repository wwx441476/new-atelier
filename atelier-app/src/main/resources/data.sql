DELETE FROM ATELIER_COPILOT_PLAYBOOK;
DELETE FROM ATELIER_DASHBOARD_SCREEN;
...
/* 2. 元数据表 orders */
INSERT INTO ATELIER_META_TABLE (PK_META_TABLE, CATALOG_CODE, TABLE_CODE, TABLE_NAME, PK_DATASOURCE, SCHEMA_CODE, COMMENTS, CREATE_TIME, MODIFY_TIME)
VALUES ('mt-orders', 'finance', 'orders', '订单事实表', 'ds-demo', 'PUBLIC', '演示订单表', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
/* 元数据表 dept（物理部门表） */
INSERT INTO ATELIER_META_TABLE (PK_META_TABLE, CATALOG_CODE, TABLE_CODE, TABLE_NAME, PK_DATASOURCE, SCHEMA_CODE, COMMENTS, CREATE_TIME, MODIFY_TIME)
VALUES ('mt-dept', 'finance', 'dept', '部门表', 'ds-demo', 'PUBLIC', '物理部门主数据', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
/* 6. 示例大屏 — 财务经营监控 */
INSERT INTO ATELIER_DASHBOARD_SCREEN (PK_DASHBOARD, SCREEN_CODE, SCREEN_NAME, CATALOG_CODE, DEFINITION_JSON, ENABLED, CREATE_TIME, MODIFY_TIME) VALUES
('dash-demo', 'finance-overview', '财务经营监控大屏', 'finance',
 '{"id":"dash-demo","code":"finance-overview","name":"财务经营监控大屏","description":"演示大屏：指标、预警与数据库直查","enabled":true,"layout":{"width":1920,"height":1080,"gridCols":24,"rowHeight":30,"theme":"tech-blue"},"widgets":[{"id":"w-title","type":"TITLE","title":"财务经营监控大屏","x":0,"y":0,"w":24,"h":2,"content":"财务经营监控大屏","style":{"fontSize":32,"color":"#69b1ff","textAlign":"center"}},{"id":"w-revenue","type":"METRIC_VALUE","title":"营业收入","x":0,"y":2,"w":8,"h":4,"dataSource":{"bindType":"METRIC","metricCodes":["revenue"],"valueField":"revenue","pageSize":20,"valueFormat":"{value}美元"}},{"id":"w-cost","type":"METRIC_VALUE","title":"营业成本","x":8,"y":2,"w":8,"h":4,"dataSource":{"bindType":"METRIC","metricCodes":["cost"],"valueField":"cost","pageSize":20,"valueFormat":"{value}美元"}},{"id":"w-profit","type":"METRIC_VALUE","title":"利润","x":16,"y":2,"w":8,"h":4,"dataSource":{"bindType":"METRIC","metricCodes":["profit"],"valueField":"profit","pageSize":20,"valueFormat":"{value}美元"}},{"id":"w-revenue-chart","type":"METRIC_CHART","title":"各部门营业收入","x":0,"y":6,"w":12,"h":8,"dataSource":{"bindType":"METRIC","metricCodes":["revenue"],"categoryField":"dept_code","valueField":"revenue","chartType":"bar","pageSize":20,"valueMappings":{"dept_code":{"001":"销售部","002":"研发部"}}}},{"id":"w-profit-chart","type":"METRIC_CHART","title":"各部门利润趋势","x":12,"y":6,"w":12,"h":8,"dataSource":{"bindType":"METRIC","metricCodes":["profit"],"categoryField":"dept_code","valueField":"profit","chartType":"line","pageSize":20,"valueMappings":{"dept_code":{"001":"销售部","002":"研发部"}}}},{"id":"w-metric-table","type":"METRIC_TABLE","title":"指标明细（部门×财年）","x":0,"y":14,"w":14,"h":10,"dataSource":{"bindType":"METRIC","metricCodes":["revenue","cost","profit"],"pageSize":20,"valueMappings":{"dept_code":{"001":"销售部","002":"研发部"}}}},{"id":"w-warn-profit","type":"WARNING_STAT","title":"利润过低预警","x":14,"y":14,"w":5,"h":5,"dataSource":{"bindType":"WARNING","ruleId":"wr-1","pageSize":20}},{"id":"w-warn-composite","type":"WARNING_STAT","title":"低利润+备注违规","x":19,"y":14,"w":5,"h":5,"dataSource":{"bindType":"WARNING","ruleId":"wr-3","pageSize":20}},{"id":"w-warn-table","type":"WARNING_TABLE","title":"组合规则命中明细","x":14,"y":19,"w":10,"h":5,"dataSource":{"bindType":"WARNING","ruleId":"wr-3","pageSize":10}},{"id":"w-sql-orders","type":"SQL_TABLE","title":"订单表（数据库直查）","x":0,"y":24,"w":24,"h":6,"dataSource":{"bindType":"SQL","queryMode":"TABLE","datasourceId":"ds-demo","tableName":"orders","pageSize":10,"columnLabels":{"id":"唯一标识","dept_id":"部门ID","dept_code":"部门编码","fiscal_year":"财年","amount":"金额","cost_amount":"成本","remark":"备注","project_name":"项目名称"},"valueMappings":{"dept_code":{"001":"销售部","002":"研发部"}}}}]}',
 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

/* 7. Copilot 技能 — 国有资产分析大屏搭建流程 */
INSERT INTO ATELIER_COPILOT_PLAYBOOK (PK_PLAYBOOK, PLAYBOOK_CODE, PLAYBOOK_NAME, DEFINITION_JSON, ENABLED, USAGE_COUNT, CREATE_TIME, MODIFY_TIME) VALUES
('pb-asset', 'state-asset-dashboard', '国有资产分析大屏',
 '{"id":"pb-asset","code":"state-asset-dashboard","name":"国有资产分析大屏","description":"从截图搭建国有资产分析全景：建表、元数据、指标、预警、大屏","enabled":true,"usageCount":0,"triggerKeywords":["国有资产","资产分析","分析全景","state_asset"],"steps":[{"title":"创建资产物理表","tool":"create_physical_table","order":1},{"title":"从物理库同步元数据","tool":"import_meta_tables","order":2},{"title":"创建指标","tool":"create_metric","order":3},{"title":"创建预警规则","tool":"create_warning_rule","order":4},{"title":"生成可视化大屏","tool":"create_dashboard","order":5}]}',
